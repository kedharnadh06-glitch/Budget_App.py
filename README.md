Budget App
Project Overview
The Budget App is a simple Python application that helps users track their spending across multiple budget categories. It supports adding deposits, withdrawals, and transfers between categories, and provides a visual bar chart to show the percentage spent in each category.
